...
export function Hero({ section }: { section?: SectionContent | null }) {
  ...
  return (
    ...
    >
      ...
      {/* ── Overlays ─────────────────────────────────────────────────────── */}
      {/* Dégradé gauche : noircit le fond pour lisibilité du texte */}
      ...
      {/* ── Contenu ──────────────────────────────────────────────────────── */}
      <motion.div
        className="container-px mx-auto max-w-7xl w-full pb-24 pt-32"
        style={{ y: contentY }}
      >
        <div className="max-w-[600px] lg:max-w-[55%]">
          ...
          <motion.p
            ...
            className="mt-6 max-w-[480px] text-base leading-relaxed text-white/65"
          >
            {subtitle}
          </motion.p>
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-8 py-3.5 text-sm font-semibold text-white tracking-wide backdrop-blur-sm transition-all duration-300 hover:border-[#7C3AED]/60 hover:bg-[#7C3AED]/10 hover:-translate-y-0.5 active:translate-y-0"
            >
              {DEFAULTS.cta2Text}
            </Link>
          </motion.div>
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <span className="text-[10px] uppercase tracking-[0.35em] text-white/30">Défiler</span>
