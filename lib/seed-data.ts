...
export const services: Service[] = [
  ...
  },
  {
    ...
    title: "Gestion campagne publicitaire",
    short_description: "Google Ads, Meta Ads et campagnes digitales pilotés pour maximiser votre retour sur investissement.",
    full_description:
      "Prestigia Agency planifie, crée et optimise vos campagnes publicitaires sur Google Ads, Meta Ads (Facebook & Instagram), TikTok Ads et LinkedIn Ads. Du brief créatif au rapport de performance, nous gérons chaque euro de budget pour maximiser votre ROI et générer des leads qualifiés au Maroc.",
    icon: "Megaphone",
    meta_title: "Gestion Campagne Publicitaire Maroc | Prestigia Agency",
    meta_description: "Gestion de campagnes Google Ads, Meta Ads et TikTok Ads au Maroc. ROI maximisé, leads qualifiés, reporting transparent pour votre entreprise.",
    keywords: "gestion campagne publicitaire Maroc, Google Ads Casablanca, Meta Ads Maroc, Facebook Ads Maroc",
    advantages: ["Budget optimisé au quotidien", "Créatifs publicitaires inclus", "Reporting transparent bi-mensuel", "Ciblage précis audience Maroc"],
    process: ["Audit & objectifs", "Stratégie & créatifs", "Lancement & suivi", "Optimisation continue"],
    faq: [
      { question: "Quel budget minimum pour commencer ?", answer: "Nous recommandons un budget publicitaire minimum de 3 000 MAD/mois pour obtenir des résultats significatifs." },
      { question: "Gérez-vous plusieurs plateformes en même temps ?", answer: "Oui, nous pouvons gérer simultanément Google Ads, Meta Ads et TikTok Ads avec une stratégie multicanale cohérente." },
    ],
  ...
  },
  {
    ...
    short_description: "Motion design, animation 3D et vidéos immersives pour donner vie à votre marque.",
    full_description:
      "Prestigia Agency crée des vidéos 3D et animations motion design sur mesure : explainer vidéos, animations de produits, intros de marque et contenus immersifs. Nous donnons vie à vos idées avec des visuels qui marquent les esprits et boostent l'engagement sur tous vos canaux digitaux.",
    icon: "Clapperboard",
    meta_title: "Vidéo 3D & Animation Motion Design Maroc | Prestigia Agency",
    meta_description: "Création vidéo 3D, animation motion design et explainer vidéo au Maroc. Des visuels immersifs pour booster votre marque et votre engagement.",
    keywords: "vidéo 3D Maroc, animation motion design Casablanca, explainer vidéo Maroc, production vidéo 3D",
    advantages: ["Animation 3D haut de gamme", "Motion design sur mesure", "Livraison tous formats (web, social, TV)", "Révisions incluses"],
    process: ["Brief créatif", "Storyboard", "Animation & rendu", "Livraison & formats"],
    faq: [
      { question: "Quel est le délai pour une vidéo 3D ?", answer: "Selon la complexité, comptez 2 à 4 semaines de production pour une animation 3D soignée." },
      { question: "Pour quels supports livrez-vous ?", answer: "Nous livrons en HD/4K pour le web, réseaux sociaux, affichage digital et diffusion TV." },
    ],
    related: ["creation-contenu-photo-video", "branding-identite-visuelle"],
    order: 10,
    active: true,
  },
  {
    ...
    short_description: "Organisation, communication et couverture digitale de vos événements professionnels au Maroc.",
    full_description:
      "Prestigia Agency prend en charge la gestion complète de vos événements : planification, identité visuelle événementielle, communication digitale avant/pendant/après, live social media, shooting photo & vidéo sur place et reportage. Du séminaire d'entreprise au lancement de produit, nous créons des expériences mémorables.",
    icon: "CalendarCheck",
    meta_title: "Gestion Événement Professionnel Maroc | Prestigia Agency",
    meta_description: "Organisation et communication digitale d'événements professionnels au Maroc. Planning, identité visuelle, live social media et couverture photo/vidéo.",
    keywords: "gestion événement Maroc, organisation événement Casablanca, communication événementielle Maroc, agence événementielle Casablanca",
    advantages: ["Planification clé en main", "Identité visuelle événementielle", "Live coverage réseaux sociaux", "Shooting photo & vidéo inclus"],
    process: ["Brief & planning", "Identité & supports", "Communication digitale", "Couverture le jour J"],
    faq: [
      { question: "Intervenez-vous hors de Casablanca ?", answer: "Oui, nous couvrons tout le Maroc pour vos événements professionnels." },
      { question: "Gérez-vous aussi la communication avant l'événement ?", answer: "Absolument : teaser, invitations digitales, posts réseaux sociaux et emailing de rappel sont inclus dans notre prestation." },
    ],
    related: ["community-management-casablanca", "creation-contenu-photo-video"],
    order: 11,
    active: true,
...
export const projects = [
  {
    ...
    description: "Digitalisation complète et refonte de la présence digitale d'Arena Ville Verte.",
    services: ["Site Web", "SEO Local", "Social Media"],
    logo_url: "",
  ...
  },
  {
    ...
    description: "Stratégie SEO complète pour générer des leads qualifiés dans le secteur BTP.",
    services: ["SEO", "Contenu", "Refonte Site"],
    logo_url: "",
  ...
  },
  {
    ...
    description: "Création d'une identité visuelle internationale pour Barça Academy Maroc.",
    services: ["Branding", "Photo / Vidéo", "Communication"],
    logo_url: "",
...
export const blogPosts = [
  {
    ...
    meta_title: "Comment choisir une agence marketing digital | Prestigia Agency",
    meta_description: "Guide complet et checklist pour sélectionner la meilleure agence marketing digital adaptée à votre budget et vos objectifs au Maroc.",
  },
  {
    id: "blog-2",
    ...
    meta_title: "SEO local Casablanca : guide pour apparaître sur Google Maps | Prestigia Agency",
    meta_description: "Tous les leviers SEO local pour améliorer votre visibilité à Casablanca : Google Business Profile, avis clients, cohérence NAP et contenu local.",
  },
];
